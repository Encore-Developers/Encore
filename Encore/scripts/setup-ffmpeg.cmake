...
function(setup_ffmpeg)
    ...
    if(WIN32)
        if(CMAKE_SIZEOF_VOID_P EQUAL 8)
            set(FFMPEG_URL "https://github.com/JaydenzKoci/ffmpeg/releases/download/release/ffmpeg-windows-x64.zip")
            set(PLATFORM_NAME "Windows x64")
        else()
            set(FFMPEG_URL "https://github.com/JaydenzKoci/ffmpeg/releases/download/release/ffmpeg-windows-x86.zip")
    ...
    elseif(APPLE)
        set(FFMPEG_URL "https://github.com/JaydenzKoci/ffmpeg/releases/download/release/ffmpeg-macos.zip")
        ...
        set(USE_DOWNLOAD TRUE)
    elseif(UNIX)
        set(FFMPEG_URL "https://github.com/JaydenzKoci/ffmpeg/releases/download/release/ffmpeg-linux-x64.zip")
    ...
    if(USE_DOWNLOAD)
        ...
        if(NOT ffmpeg_prebuilt_POPULATED)
            message(STATUS "Downloading FFmpeg prebuilt binaries from ${FFMPEG_URL}...")
        ...
        elseif(UNIX)
            ...
            set(FFMPEG_LOCAL_DIR "${CMAKE_CURRENT_SOURCE_DIR}/lib/ffmpeg/windows")
        endif()
