...
void DrawTextRubik32(const char* text, float posX, float posY, Color color)  {
    DrawTextEx(rubik32, text, { posX,posY }, 32, 1, color);
}
void DrawTextRubik(const char* text, float posX, float posY, float fontSize, Color color)  {
    DrawTextEx(rubik, text, { posX,posY }, fontSize, 1, color);
}
void DrawTextRHDI(const char* text, float posX, float posY, Color color)  {
    DrawTextEx(redHatDisplayItalic, text, { posX,posY }, 48, 1, color);
}
float MeasureTextRubik32(const char* text)  {
