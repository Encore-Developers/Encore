...
std::unordered_map<int, std::string> Keybinds::keymap = {
		{KEY_SPACE,"Space"},
		{KEY_ESCAPE,"Esc"},
		{KEY_ENTER,"Enter"},
		{KEY_TAB,"Tab"},
...
std::string Keybinds::getKeyStr(int keycode)
{
	if (keycode >= 39 && keycode < 96) {
		...
		auto it = Keybinds::keymap.find(keycode);
		if (it != Keybinds::keymap.end())
		{
			return it->second;
		}
		else
...
std::unordered_map<int, std::string> Keybinds::GenericNames{
...
std::unordered_map<int, std::string> Keybinds::XBOXNames{
...
std::unordered_map<int, std::string> Keybinds::PS1PS2Names{
...
std::unordered_map<int, std::string> Keybinds::PS3Names{
	{GLFW_GAMEPAD_BUTTON_CROSS, "X"},
	{GLFW_GAMEPAD_BUTTON_CIRCLE, "Circle"},
	{GLFW_GAMEPAD_BUTTON_SQUARE, "Square"},
	{GLFW_GAMEPAD_BUTTON_TRIANGLE, "Triangle"},
...
std::unordered_map<int, std::string> Keybinds::PS4Names{
	{GLFW_GAMEPAD_BUTTON_CROSS, "X"},
	{GLFW_GAMEPAD_BUTTON_CIRCLE, "Circle"},
	{GLFW_GAMEPAD_BUTTON_SQUARE, "Square"},
	{GLFW_GAMEPAD_BUTTON_TRIANGLE, "Triangle"},
...
std::unordered_map<int, std::string> Keybinds::PS5Names{
	{GLFW_GAMEPAD_BUTTON_CROSS, "X"},
	{GLFW_GAMEPAD_BUTTON_CIRCLE, "Circle"},
	{GLFW_GAMEPAD_BUTTON_SQUARE, "Square"},
	{GLFW_GAMEPAD_BUTTON_TRIANGLE, "Triangle"},
...
std::vector<std::vector<std::string>> Keybinds::controllerTypeNames{
	{},
...
int Keybinds::getControllerType(const std::string& searchString) {
...
std::string Keybinds::getControllerStr(int jid, int input, int type, int direction)
{
	std::unordered_map<int, std::string> &map = Keybinds::GenericNames;
	if (type == 1) map = Keybinds::XBOXNames; //xbox
	else if (type == 2) map = Keybinds::PS1PS2Names; //PS1/2
	else if (type == 3) map = Keybinds::PS3Names; //PS3
	else if (type == 4) map = Keybinds::PS4Names; //PS4
	else if (type == 5) map = Keybinds::PS5Names; //PS5
