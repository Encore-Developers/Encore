...
void Chart::parseNotes(smf::MidiFile& midiFile, int trkidx, smf::MidiEventList events, int diff, int instrument) {
...
void Chart::parsePlasticNotes(smf::MidiFile& midiFile, int trkidx, int diff, int instrument, int hopoThresh) {
        bool odOn = false;
        bool soloOn = false;
        bool forceOn = false;
		bool tapOn = false;
...
void Chart::parsePlasticSection(smf::MidiFile& midiFile, int trkidx, int start, int end, int diff, int instrument, int hopoThresh) {
        bool odOn = false;
        bool soloOn = false;
        bool forceOn = false;
		bool tapOn = false;
...
void Chart::parsePlasticDrums(smf::MidiFile& midiFile, int trkidx, smf::MidiEventList events, int diff, int instrument, bool proDrums, bool doubleKick) {
