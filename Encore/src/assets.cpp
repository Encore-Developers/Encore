...
AssetSet gameplaySet = {
    ...
    ASSETPTR(smasherOnTex),
    ASSETPTR(smasherOffTex),
    ASSETPTR(smasherFrame),
    ASSETPTR(smasherFrameTex),
    ASSETPTR(trackSurface),
    ASSETPTR(rails),
    ASSETPTR(trackRailsTex),
    ASSETPTR(kickFrame),
    ASSETPTR(kickPiston),
    ...
    ASSETPTR(overdriveMeter),
    ASSETPTR(overdriveMeterTex),
    ...
    ASSETPTR(multiplierFrameShader),
    ASSETPTR(multiplierFill),
    ASSETPTR(multiplierFrame),
    ASSETPTR(multNumShader),
    ASSETPTR(multNumPlane),
    ASSETPTR(multNumTex),
    ASSETPTR(mainLyricBar),
    ASSETPTR(secLyricBar),
    ASSETPTR(beatline),
    ASSETPTR(beatlineTex),
    ASSETPTR(missSound),
    ASSETPTR(activateSound)
};
