...
void GameplayMenu::Load() {
    ...
    std::filesystem::path songPath(TheSongList.curSong->songInfoPath);
    std::filesystem::path videoPath = songPath.parent_path() / "video.mp4";
    if (backgroundVideo.Load(videoPath)) {
